...
/// <summary>
/// Contains unit tests for <see cref="CreateCustomerCommandValidator"/>.
...
public sealed class CreateCustomerCommandValidatorTests
{
    ...
    public void Validate_WhenFirstNameIsEmpty_ShouldReturnFirstNameRequiredError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.FirstName) &&
    ...
    public void Validate_WhenMiddleNameExceeds100Characters_ShouldReturnMaxLengthError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.MiddleName) &&
    ...
    public void Validate_WhenMiddleNameIsWhitespace_ShouldNotReturnMiddleNameError()
    {
        ...
        result.Errors.Should().NotContain(x => x.PropertyName == nameof(CreateCustomerCommand.MiddleName));
    }
    ...
    public void Validate_WhenLastNameIsEmpty_ShouldReturnLastNameRequiredError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.LastName) &&
    ...
    public void Validate_WhenSecondLastNameExceeds100Characters_ShouldReturnMaxLengthError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.SecondLastName) &&
    ...
    public void Validate_WhenSecondLastNameIsNull_ShouldNotReturnSecondLastNameError()
    {
        ...
        result.Errors.Should().NotContain(x => x.PropertyName == nameof(CreateCustomerCommand.SecondLastName));
    }
    ...
    public void Validate_WhenCommercialNameExceeds200Characters_ShouldReturnMaxLengthError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.CommercialName) &&
    ...
    public void Validate_WhenPersonTypeIsEmpty_ShouldReturnPersonTypeRequiredError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.PersonType) &&
    ...
    public void Validate_WhenPersonTypeIsValidEnum_ShouldNotReturnPersonTypeError(string personType)
    {
        ...
        result.Errors.Should().NotContain(x => x.PropertyName == nameof(CreateCustomerCommand.PersonType));
    }
    ...
    public void Validate_WhenIdentificationTypeIdIsEmpty_ShouldReturnIdentificationTypeRequiredError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.IdentificationTypeId) &&
    ...
    public void Validate_WhenIdentificationNumberIsEmpty_ShouldReturnIdentificationNumberRequiredError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.IdentificationNumber) &&
    ...
    public void Validate_WhenTwoAddressesAreMarkedAsDefault_ShouldReturnMultipleDefaultAddressError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.Addresses) &&
    ...
    public void Validate_WhenTwoContactsAreMarkedAsPrimary_ShouldReturnMultiplePrimaryContactError()
    {
        ...
        result.Errors.Should().Contain(x =>
            x.PropertyName == nameof(CreateCustomerCommand.Contacts) &&
    ...
    private static CreateCustomerCommand.CreateCustomerAddressDto CreateValidAddressDto(bool isDefault = false) =>
        new()
        {
    ...
    private static CreateCustomerCommand.CreateCustomerContactDto CreateValidContactDto(bool isPrimary = false) =>
        new()
        {
