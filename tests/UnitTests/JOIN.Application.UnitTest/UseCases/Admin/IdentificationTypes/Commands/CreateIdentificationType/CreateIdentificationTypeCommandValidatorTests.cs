...
/// <summary>
/// Contains unit tests for <see cref="CreateIdentificationTypeCommandValidator"/>.
/// </summary>
public sealed class CreateIdentificationTypeCommandValidatorTests
{
    private readonly CreateIdentificationTypeCommandValidator _validator = new();
    ...
    private static CreateIdentificationTypeCommand CreateValidCommand() => new()
    {
        Name = "Passport",
