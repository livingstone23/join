...
/// <summary>
/// Contains unit tests for <see cref="DeleteAreaCommandValidator"/>.
/// </summary>
public sealed class DeleteAreaCommandValidatorTests
{
    private readonly DeleteAreaCommandValidator _validator = new();
    ...
    private static DeleteAreaCommand CreateValidCommand() => new(Guid.NewGuid(), Guid.NewGuid());
}