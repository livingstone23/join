...
/// <summary>
/// Contains unit tests for <see cref="CreateAreaCommandValidator"/>.
/// </summary>
public sealed class CreateAreaCommandValidatorTests
{
    private readonly CreateAreaCommandValidator _validator = new();
    ...
    private static CreateAreaCommand CreateValidCommand() => new()
    {
