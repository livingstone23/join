...
/// <summary>
/// Contains unit tests for <see cref="UpdateEntityStatusCommandValidator"/>.
/// </summary>
public sealed class UpdateEntityStatusCommandValidatorTests
{
    private readonly UpdateEntityStatusCommandValidator _validator = new();
    ...
    private static UpdateEntityStatusCommand CreateValidCommand() => new()
    {
        Id = Guid.NewGuid(),
