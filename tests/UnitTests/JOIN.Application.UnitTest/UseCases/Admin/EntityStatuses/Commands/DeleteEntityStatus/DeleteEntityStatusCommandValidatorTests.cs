...
/// <summary>
/// Contains unit tests for <see cref="DeleteEntityStatusCommandValidator"/>.
/// </summary>
public sealed class DeleteEntityStatusCommandValidatorTests
{
    private readonly DeleteEntityStatusCommandValidator _validator = new();
    ...
    private static DeleteEntityStatusCommand CreateValidCommand() => new(Guid.NewGuid(), Guid.NewGuid());
}