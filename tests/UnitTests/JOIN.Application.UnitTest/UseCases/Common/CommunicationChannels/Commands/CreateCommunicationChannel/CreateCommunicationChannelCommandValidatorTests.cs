...
/// <summary>
/// Contains unit tests for <see cref="CreateCommunicationChannelCommandValidator"/>.
/// </summary>
public sealed class CreateCommunicationChannelCommandValidatorTests
{
    private readonly CreateCommunicationChannelCommandValidator _validator = new();
    ...
    private static CreateCommunicationChannelCommand CreateValidCommand() => new()
    {
        Name = "WhatsApp",
        Provider = "Twilio",
        Code = "WA"
