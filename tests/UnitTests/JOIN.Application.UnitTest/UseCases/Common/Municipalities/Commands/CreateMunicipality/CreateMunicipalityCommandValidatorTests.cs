...
/// <summary>
/// Contains unit tests for <see cref="CreateMunicipalityCommandValidator"/>.
/// </summary>
public sealed class CreateMunicipalityCommandValidatorTests
{
    private readonly CreateMunicipalityCommandValidator _validator = new();
    ...
    private static CreateMunicipalityCommand CreateValidCommand() => new()
    {
        Name = "Ciudad Sandino",
        Code = "CS",
