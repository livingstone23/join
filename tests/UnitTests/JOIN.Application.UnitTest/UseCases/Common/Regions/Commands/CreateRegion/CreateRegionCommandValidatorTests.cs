...
/// <summary>
/// Contains unit tests for <see cref="CreateRegionCommandValidator"/>.
/// </summary>
public sealed class CreateRegionCommandValidatorTests
{
    private readonly CreateRegionCommandValidator _validator = new();
    ...
    private static CreateRegionCommand CreateValidCommand() => new()
    {
        Name = "Pacific",
        Code = "PAC",
