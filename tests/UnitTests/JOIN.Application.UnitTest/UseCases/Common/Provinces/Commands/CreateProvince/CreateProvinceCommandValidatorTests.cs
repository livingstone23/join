...
/// <summary>
/// Contains unit tests for <see cref="CreateProvinceCommandValidator"/>.
/// </summary>
public sealed class CreateProvinceCommandValidatorTests
{
    private readonly CreateProvinceCommandValidator _validator = new();
    ...
    private static CreateProvinceCommand CreateValidCommand() => new()
    {
        Name = "Managua",
        Code = "MGA",
