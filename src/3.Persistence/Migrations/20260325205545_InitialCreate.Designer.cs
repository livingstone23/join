...
namespace JOIN.Persistence.Migrations
{
    ...
    [Migration("20260325205545_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.RoleSystemOption", b =>
                {
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.SystemOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.CompanyModule", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.SystemModule", null)
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.RoleSystemOption", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.SystemOption", "SystemOption")
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.SystemOption", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.SystemOption", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("JOIN.Domain.Security.UserCompany", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Common.Company", null)
                        .WithMany("UserCompanies")
