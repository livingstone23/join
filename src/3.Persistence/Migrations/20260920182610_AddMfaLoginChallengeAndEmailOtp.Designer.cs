...
namespace JOIN.Persistence.Migrations
{
    ...
    [Migration("20260920182610_AddMfaLoginChallengeAndEmailOtp")]
    partial class AddMfaLoginChallengeAndEmailOtp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.Customer", b =>
                {
                    ...
                    b.Property<int>("PersonLifecycleStage")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyId", "PersonLifecycleStage")
                        .HasDatabaseName("IX_Customers_Company_PersonLifecycleStage");

                    b.HasIndex("CompanyId", "CustomerCode", "GcRecord")
                        .IsUnique()
                        .HasDatabaseName("IX_Customers_Company_CustomerCode_GcRecord");

                    b.HasIndex("CompanyId", "PersonId", "UserId", "GcRecord")
                        .IsUnique()
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.Gender", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.IncomeRange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "DisplayName", "GcRecord")
                        .IsUnique()
                        .HasDatabaseName("IX_IncomeRanges_CompanyId_DisplayName_GcRecord");

                    b.HasIndex("CompanyId", "DisplayOrder", "GcRecord")
                        .IsUnique()
                        .HasDatabaseName("IX_IncomeRanges_CompanyId_DisplayOrder_GcRecord");

                    b.ToTable("IncomeRanges", "Admin");
                });

            modelBuilder.Entity("JOIN.Domain.Admin.Industry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.Person", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "IdentificationTypeId", "IdentificationNumber", "GcRecord")
                        .IsUnique()
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.PersonAddress", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PersonId", "IsDefault")
                        .HasDatabaseName("IX_PersonAddresses_Company_Person_Default");

                    b.ToTable("PersonAddresses", "Admin");
                });

            modelBuilder.Entity("JOIN.Domain.Admin.PersonBusinessProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "PersonId", "GcRecord")
                        .HasDatabaseName("IX_PersonBusinessProfiles_Company_Person_GcRecord");

                    b.ToTable("PersonBusinessProfiles", "Admin");
                });
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.PersonContact", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PersonId", "IsPrimary")
                        .HasDatabaseName("IX_PersonContacts_Company_Person_Primary");

                    b.HasIndex("PersonId", "ContactType", "ContactValue", "GcRecord")
                        .IsUnique()
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.PersonEmployment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "PersonId", "IsCurrent")
                        .HasDatabaseName("IX_PersonEmployments_Company_Person_Current");

                    b.ToTable("PersonEmployments", "Admin");
                });

            modelBuilder.Entity("JOIN.Domain.Admin.PersonFinancialProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PersonFinancialProfiles", "Admin");
                });
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.TaxRegime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JOIN.Domain.Security.EmailOtpEnableCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmailOtpEnableCodes", "Security");
                });

            modelBuilder.Entity("JOIN.Domain.Security.MfaLoginChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("EmailCodeExpiresAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("MfaLoginChallenges", "Security");
                });

            modelBuilder.Entity("JOIN.Domain.Security.PhoneVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PhoneVerificationCodes", "Security");
                });

            modelBuilder.Entity("JOIN.Domain.Security.RoleCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RoleCompanies", "Security");
                });
            ...
            modelBuilder.Entity("JOIN.Domain.Security.SecurityEventLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SecurityEventLogs", "Security");
                });

            modelBuilder.Entity("JOIN.Domain.Security.SeedState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JOIN.Domain.Security.UserMfaRecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserMfaRecoveryCodes", "Security");
                });
            ...
            modelBuilder.Entity("JOIN.Domain.Support.TicketLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsOnlyForCreatedAndAssigned")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid>("UserRegisterLogId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserRegisterLogId");

                    b.HasIndex("CompanyId", "TicketId");

                    b.HasIndex("CompanyId", "TicketId", "GcRecord")
                        .HasDatabaseName("IX_TicketLog_Tenant_Ticket_Active");

                    b.ToTable("TicketLogs", "Support");
                });
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.Person", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.Gender", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.PersonBusinessProfile", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.Industry", "Industry")
                        .WithMany()
                    ...
                    b.HasOne("JOIN.Domain.Admin.TaxRegime", "TaxRegime")
                        .WithMany()
            ...
            modelBuilder.Entity("JOIN.Domain.Admin.PersonFinancialProfile", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Admin.IncomeRange", "IncomeRange")
                        .WithMany()
            ...
            modelBuilder.Entity("JOIN.Domain.Support.TicketLog", b =>
                {
                    ...
                    b.HasOne("JOIN.Domain.Security.ApplicationUser", "NewAssignedToUser")
                        .WithMany()
                        .HasForeignKey("NewAssignedToUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("JOIN.Domain.Messaging.TicketStatus", "PreviousStatus")
                        .WithMany()
                    ...
                    b.HasOne("JOIN.Domain.Security.ApplicationUser", "UserRegistered")
                        .WithMany()
                        .HasForeignKey("UserRegisterLogId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
