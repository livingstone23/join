...
public class PersonsController(IMediator mediator) : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(Response<PagedResult<PersonListItemDto>>), StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> Create([FromBody] CreatePersonCommand command, CancellationToken cancellationToken = default)
    {
    ...
    [ProducesResponseType(typeof(Response<object>), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(Response<Guid>), StatusCodes.Status409Conflict)]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdatePersonCommand command, CancellationToken cancellationToken = default)
    {
