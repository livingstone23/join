...
[Authorize]
public class CompanyModulesController(ISender sender, ICurrentUserService currentUserService) : ControllerBase
{
    private readonly ISender _sender = sender ?? throw new ArgumentNullException(nameof(sender));
    private readonly ICurrentUserService _currentUserService = currentUserService ?? throw new ArgumentNullException(nameof(currentUserService));

    /// <summary>
    /// Retrieves a paginated list of company module assignments.
    ...
    /// <summary>
    /// Retrieves a single company module assignment by its unique identifier and company scope.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new company module assignment.
    /// </summary>
    ...
    /// <summary>
    /// Updates an existing company module assignment using the route identifier as the authoritative resource key.
    /// </summary>
    ...
    /// <summary>
    /// Performs a soft delete over a company module assignment.
    /// </summary>
