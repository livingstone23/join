...
/// <summary>
/// Defines the validation rules for the CreatePersonCommand.
...
public class CreatePersonCommandValidator : AbstractValidator<CreatePersonCommand>
{
    public CreatePersonCommandValidator()
    {
        ...
        {
            RuleForEach(x => x.Addresses!).SetValidator(new CreatePersonAddressDtoValidator());
        });

        When(x => x.Contacts is { Count: > 0 }, () =>
        {
            RuleForEach(x => x.Contacts!).SetValidator(new CreatePersonContactDtoValidator());
        });
    }

    private sealed class CreatePersonAddressDtoValidator : AbstractValidator<CreatePersonCommand.CreatePersonAddressDto>
    {
        public CreatePersonAddressDtoValidator()
        {
    ...
    private sealed class CreatePersonContactDtoValidator : AbstractValidator<CreatePersonCommand.CreatePersonContactDto>
    {
        public CreatePersonContactDtoValidator()
        {
