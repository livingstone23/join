...
public record UpdatePersonCommand : ITransactionalCommand<Response<Guid>>
{
    ...
    /// </summary>
    public IReadOnlyCollection<UpdatePersonAddressDto> Addresses { get; init; } = [];

    /// <summary>
    /// Gets or sets the full updated list of contacts.
    /// </summary>
    public IReadOnlyCollection<UpdatePersonContactDto> Contacts { get; init; } = [];

    /// <summary>
    /// DTO representing an address update item.
    /// </summary>
    public record UpdatePersonAddressDto
    {
        /// <summary>
    ...
    /// </summary>
    public record UpdatePersonContactDto
    {
        /// <summary>
