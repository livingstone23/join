...
/// <summary>
/// Query used to retrieve a paginated and filterable industry list for the authenticated tenant.
/// </summary>
...
/// <param name="Code">Optional inclusive partial-match filter applied to the industry code.</param>
/// <param name="Name">Optional inclusive partial-match filter applied to the industry name.</param>
/// <param name="IsActive">Optional exact-match filter applied to the active state.</param>
public sealed record GetIndustriesQuery(
    int? PageNumber = null,
    int? PageSize = null,
    string? Code = null,
    string? Name = null,
    bool? IsActive = null)
    : IRequest<Response<PagedResult<IndustryDto>>>;
