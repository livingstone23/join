...
/// <summary>
/// Validates the payload used to update a tenant-scoped industry.
/// </summary>
public sealed class UpdateIndustryCommandValidator : AbstractValidator<UpdateIndustryCommand>
{
