...
/// <summary>
/// Validation rules for <see cref="UpdatePersonAddressCommand"/>.
/// </summary>
public sealed class UpdatePersonAddressValidator : AbstractValidator<UpdatePersonAddressCommand>
{
    /// <summary>
    /// Initializes a new instance of the validator with all required rules.
    /// </summary>
    public UpdatePersonAddressValidator()
    {
        RuleFor(x => x.Id)
