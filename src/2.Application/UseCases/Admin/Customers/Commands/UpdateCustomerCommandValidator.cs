...
public class UpdateCustomerCommandValidator : AbstractValidator<UpdateCustomerCommand>
{
    public UpdateCustomerCommandValidator()
    {
        ...
        {
            RuleForEach(x => x.Addresses!).SetValidator(new UpdateCustomerAddressDtoValidator());
        });

        When(x => x.Contacts is { Count: > 0 }, () =>
        {
            RuleForEach(x => x.Contacts!).SetValidator(new UpdateCustomerContactDtoValidator());
        });
    }

    private sealed class UpdateCustomerAddressDtoValidator : AbstractValidator<UpdateCustomerCommand.UpdateCustomerAddressDto>
    {
    ...
    private sealed class UpdateCustomerContactDtoValidator : AbstractValidator<UpdateCustomerCommand.UpdateCustomerContactDto>
    {
