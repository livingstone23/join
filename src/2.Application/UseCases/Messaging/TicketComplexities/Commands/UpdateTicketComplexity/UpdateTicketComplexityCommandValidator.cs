...
/// <summary>
/// Defines validation rules for <see cref="UpdateTicketComplexityCommand"/>.
/// </summary>
public sealed class UpdateTicketComplexityCommandValidator : AbstractValidator<UpdateTicketComplexityCommand>
{
    public UpdateTicketComplexityCommandValidator()
    {
        RuleFor(x => x.Id)
