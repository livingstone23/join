...
/// <summary>
/// Defines validation rules for tenant ticket default configuration creation.
/// </summary>
public sealed class CreateTicketCompanyDefaultCommandValidator : AbstractValidator<CreateTicketCompanyDefaultCommand>
{
    public CreateTicketCompanyDefaultCommandValidator()
    {
